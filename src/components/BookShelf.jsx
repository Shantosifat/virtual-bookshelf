    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-100 flex justify-center items-center">
          <div className="rounded-lg bg-slate-800 p-6 w-full max-w-5xl relative">
            <button
            ...
            <h2 className="text-2xl text-white font-bold mb-5 text-center">Update Book</h2>
            <form onSubmit={handleUpdate}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-gray-100 mb-1">Cover Photo URL</label>
                  <input
                    name="photo"
                    required
                    className="w-full text-white px-4 py-2 border border-gray-300 rounded-lg"
